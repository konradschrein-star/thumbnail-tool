...
// GET /api/assets/[...path] - Serve assets from local storage
export async function GET(
    ...
    try {
        ...
        console.error(`Asset serving error (${request.url}):`, error.message);
        ...
        const errorMessage = error instanceof Error
            ? error.message
            : 'An unexpected error occurred while serving asset';
